...
function stepHit(curStep:Int) { 
    switch (curStep) {
        case 0:
		 LyricInQuestion.color = 0xFF23FF6B;
		 LyricInQuestion.borderColor = 0xFFFF234F;
		 lyricscon.loadGraphic(Paths.image('LYRICS/antyLYRICSCON'));
            UpdateLyric("I am burger king");        
        case 66:
