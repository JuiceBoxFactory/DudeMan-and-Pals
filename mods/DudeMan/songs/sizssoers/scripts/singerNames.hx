function postCreate() {
	...
	opponent = new FlxSprite(125, 800).loadGraphic(Paths.image('singerNames/GhosttaleSans'));
	...
	vs = new FlxSprite(450, 800).loadGraphic(Paths.image('singerNames/VS'));
	...
	playerName = new FlxSprite(800, 800).loadGraphic(Paths.image('singerNames/Dax'));
