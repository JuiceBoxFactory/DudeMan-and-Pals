...
if (downscroll) {
	...
	vs.y = 1200;
  	...
  	if (PlayState.SONG.meta.displayName == "life gives you lemons" || PlayState.SONG.meta.displayName == "misconduct" || PlayState.SONG.meta.displayName == "skyblue" || PlayState.SONG.meta.displayName == "lighthouse" || PlayState.SONG.meta.displayName == "sizssoers" || PlayState.SONG.meta.displayName == "unlikelyrivals") {
