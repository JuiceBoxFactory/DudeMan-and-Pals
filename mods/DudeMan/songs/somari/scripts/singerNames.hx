function postCreate() {
	...
	opponent = new FlxSprite(375, 1200).loadGraphic(Paths.image('singerNames/Antydote'));
	...
	playerName = new FlxSprite(700, 1200).loadGraphic(Paths.image('singerNames/DudeManDX'));
