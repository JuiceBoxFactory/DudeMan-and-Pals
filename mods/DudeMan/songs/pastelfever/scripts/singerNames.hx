...
function stepHit(curStep:Int) { 
    switch (curStep) {
        ...
        case 50:
            FlxTween.tween(playerName, {y: 1200}, 2, {ease:FlxEase.backInOut});	    
            FlxTween.tween(opponent, {y: 1200}, 2, {ease:FlxEase.backInOut});	 
            FlxTween.tween(vs, {y: 1200}, 2, {ease:FlxEase.backInOut});
            FlxTween.tween(thisisyou, {y: 1200}, 2, {ease:FlxEase.backInOut});
    }
}