...
function postCreate() {
	...
	if (PlayState.SONG.meta.displayName == "life gives you lemons" || PlayState.SONG.meta.displayName == "roomed" || PlayState.SONG.meta.displayName == "lighthouse" || PlayState.SONG.meta.displayName == "Pastel Fever" || PlayState.SONG.meta.displayName == "misconduct" || PlayState.SONG.meta.displayName == "sizssoers" || PlayState.SONG.meta.displayName == "unlikelyrivals") {
	cname.alpha = 0;
	sname.alpha = 0;
	fname.alpha = 0;
	songbox.alpha = 0;
